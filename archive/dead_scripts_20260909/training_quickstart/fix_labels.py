...
mutated", used at inference time to locate the mutation site). A labelled
training set needs two separate files instead: ".interaction_loss_pos" for
variants that disrupt
